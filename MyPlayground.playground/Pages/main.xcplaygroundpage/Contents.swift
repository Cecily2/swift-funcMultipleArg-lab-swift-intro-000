 ...
 */
func countries(continent: String, countries: String) {
 ...
 */
func bottles(beverage: String, bottleCount: Int, placeToKeep: String) {
    print("\(bottleCount) bottles of \(beverage) on the \(placeToKeep) wall.")
}
